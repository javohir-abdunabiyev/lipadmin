...
export default function About() {
    return (
        <div className="relative overflow-x-hidden">
            <div className="absolute sm:rotate-40 rotate-200 left-[-20px] sm:right-0 sm:top-0 top-[150px] sm:left-[-430px] w-full sm:h-[900px] h-[600px] bg-[url('/images/mainbg.png')] bg-no-repeat sm:bg-top bg-top bg-cover z-0 pointer-events-none" />
