...
export default function ClientReviews() {
    ...
    return (
        <div className="relative">
            {/* Навигация для всех устройств (используем одинаковые классы) */}
            <div className="flex justify-center sm:justify-end gap-2 mb-6 mt-[-90px] sm:mt-[-90px]">
            ...
            <Swiper
                ...
                onInit={(swiper: any) => {
                    swiper.params.navigation.prevEl = ".swiper-button-prev-reviews";
                    swiper.params.navigation.nextEl = ".swiper-button-next-reviews";
                    ...
                    <SwiperSlide key={review.id}>
                        <div className="flex flex-col max-w-[657px] w-full pt-[25px] px-[10px] sm:h-[338px] bg-white border-[2px] border-gray-200 rounded-xl shadow-md hover:shadow-lg transition-shadow text-left">
                            <div className="px-[21px] pb-[20px] flex flex-col h-full">
                                <h3 className="font-[600] sm:text-[26px] text-[20px] text-black mb-[6px]">
                                    {review.name}
                                </h3>
                                <div className="flex items-center gap-[6px] pb-[16px] border-b border-[rgba(0,0,0,0.1)]">
                                    <img src="/images/reviewsStar.png" alt="" />
                                    <p className="text-[16px] font-[400] text-[rgba(214,40,40,1)]">
                                        {review.position}
                                    </p>
                                </div>
                                <p className="text-[16px] text-[rgba(0,0,0,0.8)] font-[400] mt-[16px]">
                                    {review.text}
                                </p>
                            </div>
                        </div>
